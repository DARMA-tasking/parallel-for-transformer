...
#if !defined INCLUDED_CHECKPOINT_MEMBER_ANALYZER_QUALIFIED_NAME_H
#define INCLUDED_CHECKPOINT_MEMBER_ANALYZER_QUALIFIED_NAME_H
...
#endif /*INCLUDED_CHECKPOINT_MEMBER_ANALYZER_QUALIFIED_NAME_H*/
